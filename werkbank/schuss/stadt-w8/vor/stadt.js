...
(function (B) {
  ...
  function zeichneReiter(liste, ruhend) {
    ...
    liste.forEach(function (b) {
      ...
      /* Die Kennzahl gehoert AUCH in den Titel. (Welle 7)

         Gemessen bei 1366x768: der Reiter ist dort rund 100 px breit, die
         lebende Kennzahl des Bretts braucht bis zu 253 px — "wollen 15 · im
         Keller liegen 4 Fass" steht mit Auslassungspunkten da, und das ist
         abgeschnittener Text im Sinn der vierten Latte. Zehn Reiter in einer
         Zeile von 1.093 px koennen ihn nicht alle vollstaendig tragen; das
         ist Arithmetik und keine Nachlaessigkeit.

         Was in der Hand des Stuecks liegt, ist die Erreichbarkeit: der
