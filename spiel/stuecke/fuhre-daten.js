    ...
    1: {
      ...
      ziel: {
        ...
        stufen: [
          ...
          { k: 'ziel', name: 'Aufs Kerbholz, fällig zu Michaeli', bar: 0.34, durst: 1.00, ausfall: 0.05,
    ...
    2: {
      ...
      ziel: {
        ...
        stufen: [
          ...
          { k: 'ziel', name: 'Auf Ziel bis Michaeli', bar: 0.36, durst: 1.00, ausfall: 0.05,
    ...
    3: {
      ...
      ziel: {
        ...
        stufen: [
          ...
          { k: 'ziel', name: 'Rechnung auf dreißig Tage', bar: 0.46, durst: 1.00, ausfall: 0.045,
    ...
    4: {
      ...
      ziel: {
        ...
        stufen: [
          ...
          { k: 'ziel', name: 'Rechnung, dreißig Tage netto', bar: 0.60, durst: 1.00, ausfall: 0.035,
