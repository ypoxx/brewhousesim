  ...
  epochen: {
    ...
    1: {
      ...
      wagen: { name: 'Ochsenkarren', fass: 4, halte: 4, schritt: 1,
               grund: 3, jeKm: 2.5, umlauf: 2, bruch: 0.03,
    ...
    2: {
      ...
      wagen: { name: 'Pferdefuhrwerk', fass: 8, halte: 8, schritt: 1,
               grund: 9, jeKm: 9, umlauf: 3, bruch: 0.04,
               satz: 'Acht Plätze, zwei Pferde. Die Fässer kommen erst nach Wochen zurück.' },
      faesser: 38,
      mengenfaktor: 1,
      winteranteil: 0.68,
    ...
    4: {
      ...
      wagen: { name: 'Lastzug', fass: 300, halte: 3, schritt: 20,
               grund: 600, jeKm: 40, haltPreis: 1800, umlauf: 1, bruch: 0.01,
