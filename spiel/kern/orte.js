...
(function (B) {
  ...
  var LISTE = [
    ...
    { schluessel: 'gaertanks',    name: 'Gaertanks',            x: 45, y: 50, art: 'bau', ab: 3,
    ...
    { schluessel: 'strasse',      name: 'Landstrasse',          x: 50, y: 89, art: 'stadt',
    ...
    { schluessel: 'bruecke_unten', name: 'Untere Bruecke',      x: 88, y: 70, art: 'wasser',
      sagt: 'Holzsteg 1350, Steinbogen ab 1600.' },
    { schluessel: 'bruecke_oben', name: 'Obere Bruecke',        x: 84, y: 40, art: 'wasser',
      sagt: 'Die zweite Querung, flussaufwaerts.' },
    { schluessel: 'muehle',       name: 'Die Muehle',           x: 85, y: 38, art: 'land',
